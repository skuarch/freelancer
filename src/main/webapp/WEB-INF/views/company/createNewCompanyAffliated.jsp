                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="form-group"> 
                                                ...
                                                <input name="taxContactName" id="taxContactName" maxlength="255" class="form-control" type="text" required="required" tabindex="15" />
                                            </div> 
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="form-group"> 
                                                <label><spring:message code="text306" /></label>
                                                <input name="taxContactLastName" id="taxContactLastName" maxlength="255" class="form-control" type="text" required="required" tabindex="15" />
                                            </div> 
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="form-group"> 
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group"> 
                                                ...
                                                <input name="taxId" id="taxId" placeholder="<spring:message code="text316" />" maxlength="13" class="form-control" type="text" required="required" tabindex="11" />
                                            </div> 
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="form-group"> 
                                                <label><spring:message code="text309" /></label>
                                                <input name="taxCompanyName" id="taxCompanyName" maxlength="55" class="form-control" type="text" required="required" tabindex="12" />
                                            </div> 
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="form-group"> 
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group"> 
                                                ...
                                                <input name="address" id="address" placeholder="<spring:message code="text79"/>" maxlength="512" class="form-control" type="text" required="required" tabindex="13" />
                                            </div> 
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="form-group"> 
                                                <label><spring:message code="text82" /></label>
                                                <input name="country" id="country" placeholder="<spring:message code="text83"/>" maxlength="35" class="form-control" type="text" required="required" tabindex="14" />
                                            </div> 
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="form-group"> 
                                                <label><spring:message code="text121" /></label>
                                                <input name="state" id="state" placeholder="" class="form-control" maxlength="55" type="text" required="required" tabindex="15" />
                                            </div> 
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="form-group"> 
                                                <label><spring:message code="text84" /></label>
                                                <input name="city" id="city" placeholder="<spring:message code="text85"/>" maxlength="55" class="form-control" type="text" required="required" tabindex="16" />
                                            </div> 
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="form-group"> 
                                                <label><spring:message code="text80" /></label>
                                                <input name="zipCode" id="zipCode" placeholder="<spring:message code="text81"/>" min="1" max="99999999" class="form-control" type="number" required="required" tabindex="17" />
                                            </div> 
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="form-group"> 
                                                ...
                                                <input name="ownerAccountBank" id="ownerAccountBank" maxlength="255" class="form-control" type="text" required="required" tabindex="18" />
                                            </div> 
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="form-group"> 
                                                <label><spring:message code="text313" /></label>
                                                <input name="bank" id="bank" maxlength="55" class="form-control" type="text" required="required" tabindex="19" />
                                            </div> 
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="form-group"> 
                                                <label><spring:message code="text314" /></label>
                                                <input name="clabe" id="clabe" maxlength="25" class="form-control" type="text" required="required" tabindex="20" />
                                            </div> 
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="form-group"> 
                                                <label><spring:message code="text315" /></label>
                                                <input name="emailNotifications" id="emailNotifications"  class="form-control" maxlength="35" type="email" required="required" tabindex="21" />
                                            </div> 
                                        </div>                                                                
                                    </div>
                                </div>
