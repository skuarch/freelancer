                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <form action="createEstablishment.html" role="form" method="post" id="createEstablishment" name="createEstablishment">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="panel panel-default">
                                                <div class="panel-heading">
                                                    AQUI VA LA COASA ESA
                                                </div>    
                                                <div class="panel-body">
